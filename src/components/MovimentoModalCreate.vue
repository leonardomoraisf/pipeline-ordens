<template>
    <div>
            ...
            <div class="relative mx-auto modal-movimento">
                <div class="bg-white w-full rounded-md h-full">
                    <div
                        ...
                        <h5 class="font-semibold text-xl text-gray-900/70 mr-32">Nova venda</h5>
                        <button type="button"
                    ...
                    <div class="w-full h-full">
                        ...
                        <iframe v-show="!isLoadingIframe" :src="frameMovimentoUrl" ref="iframe" width="100%" height="100%"
                            @load="onLoad"></iframe>
                    </div>
                </div>
            </div>
        ...
        <div v-if="clickCancel" class="absolute inset-0 z-40 opacity-25 bg-black"></div>
...
export default {
    ...
    data() {
        return {
            ...
            frameMovimentoUrl: 'http://localhost:8585/app/vendas/nova-venda?pipeline=1',
