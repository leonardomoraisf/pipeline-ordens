<template>
    <div>
        ...
        <div class="group mb-0 relative hover:cursor-pointer" @click="toggleModalEditStatusFunc">
            ...
            <div class="flex items-center" v-if="list.ordem === 1">
            ...
            <div class="mt-3 h-8 max-h-8 overflow-hidden whitespace-nowrap text-ellipsis">
        ...
        <SideModal :list="list" :lastList="lastList" :toggleModal="toggleStatusEditModal"
            ...
            ref="sideModalEdit" :ajustarCorTexto="ajustarCorTexto"></SideModal>
