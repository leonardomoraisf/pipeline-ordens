  ...
  <div class="flex flex-col h-screen bg-white relative text-center">
    <div class="shrink-0 p-4">
      <transition name="fade">
        <div
          class="flex flex-col justify-center items-center fixed top-2 right-2"
      ...
      <button
        class="float-left hover:scale-125 back-button"
      ...
      <div
        class="shrink-0 flex justify-center bg-white px-4 py-3 container mx-auto"
      >
        <input
...
export default {
  ...
  methods: {
    ...
    onStatusDeleted(list) {
      ...
      ToastTopEnd5.fire(
        "Opa!",
        `O status ${list.nome} foi inativado!`,
        "info"
      );
      ...
      // Pega a última lista novamente
      this.lastList = this.listBoards[this.listBoards.length - 1] ? this.listBoards[this.listBoards.length - 1] : {ordem:0};
    },
    /**
...
@font-face {
  ...
  font-style: normal;
  font-weight: 100 700;
  src: url("../assets/icons/kJEhBvYX7BgnkSrUwT8OhrdQw4oELdPIeeII9v6oFsI.woff2")
    format("woff2");
}
